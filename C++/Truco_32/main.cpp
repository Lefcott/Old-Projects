...
#define px 65
#define py 5
#define pw 20//PROGRAMADO POR 01001100 01100101 01100001 01101110 01100100 01110010 01101111 00100000 01000011 01101111 01110100 01110100 01101001;
#define ph 34
#define psql 5
#define psqsepl 3
#define psqseps 2
...
void mat_min(), COO2(), pedir_tecla(int cantar), borrar();
...
void cartas(int MM){
	...
	if(MM == 1){
		env_fl(1);
		aux(1, 18);  printf("ESC: al mazo				%s", (mesa[0][0] == vec_num) ? "A: envido" : "");
...
void DTT(){
	...
	aux(3, 31); printf((dib == 1) ? "LLLLLLLL FF   FF    CCCCCCCC LL   LL FFFFF   CC   CC  LLLL" : (dib == 2) ? "LLLLLLLL FFFFF   CC   CC  LLLLL  FFFF" : (dib == 3) ? "LLLLL   FFFFFF CCCCCCCC LLLLL   FF   FF  CCCCC  LLLL" :  (dib == 4) ? "LL      LL   F     CC    LLLLLL      FFFFF CC   CC     L    FFFFFFFF CCCCC    LLLLL" : " ");
	aux(3, 32); printf((dib == 1) ? "   LL    FF   FF       CC    LL   LL FF  FF  CCC  CC LL  LL" :(dib == 2) ? "   LL    FF  FF  CC   CC LL     FF  FF" :(dib == 3) ? "LL  LL  FF        CC    LL  LL  FF   FF CC     LL  LL" : (dib == 4) ? " LL    LL   FFF    CC    LL         FF     CC   CC    LLL      FF    CC  CC  LL   LL" : " ");
	aux(3, 33); printf((dib == 1) ? "   LL    FF   FF       CC    LL   LL FFFF    CC C CC LL  LL" :(dib == 2) ? "   LL    FFFF    CC   CC LL     FF  FF" :(dib == 3) ? "LLLL    FFFF      CC    LLLL    FF   FF CC     LL  LL" : (dib == 4) ? "  LL  LL   FF FF   CC    LLLL       FF     CC   CC   LL LL     FF    CCCC    LL   LL" : " ");
	aux(3, 34); printf((dib == 1) ? "   LL    FF   FF       CC    LL   LL FF  FF  CC  CCC LL  LL" :(dib == 2) ? "   LL    FF  FF  CC   CC LL     FF  FF" :(dib == 3) ? "LL  LL  FF        CC    LL  LL  FF   FF CC     LL  LL" : (dib == 4) ? "   LLLL   FFFFFFF  CC    LL         FF     CC   CC  LLLLLLL    FF    CC  CC  LL   LL" : " ");
	aux(3, 35); printf((dib == 1) ? "   LL     FFFFF        CC     LLLLL  FF   FF CC   CC  LLLL" : (dib == 2) ? "   LL    FF   FF  CCCCC   LLLLL  FFFF" : (dib == 3) ? "LL   LL FFFFFF    CC    LL   LL  FFFFF   CCCCC  LLLL" :  (dib == 4) ? "    LL   FF     FF CCCCC LLLLLL      FFFFF  CCCCC  LL     LL   FF    CC   CC  LLLLL" : " ");
	if(llamar == 1){
		llamar = 0;
