...
void truco(bool en_resp), truco_resp(), menu(), ins(), juego(), REINICIAR();
...
int cant(int rango), MMM(int ret), car_disp(), env_fl(int JM), pun_gan(), suma_tantos();
...
void menu(){
	...
	aux(15, 14); printf("                   ENTER: JUGAR");
	aux(15, 17); printf("                TAB: INSTRUCCIONES");
	aux(15, 20); printf("                   ESCAPE: SALIR");
}
void ins(){
